...
하지만 **문제를 푸는 방식을 바꾸는 것**은 받아들이기 쉬울 수 있다.
...
## 5. 실패한 실험에서도 다음 시도의 단서를 남긴다

다음에 사업을 한다면 아래 순서로 실험하고 싶다. PMF(Product-Market Fit)는 제품이 시장의 수요에 맞아들어가는 상태를 말한다.
...
이미 검증된 아이디어를 키우는 Expand나 효율을 짜내는 Extract 단계라면 우선순위는 달라진다.
