...
그렇다고 제한을 없애는 것도 답은 아니다. 토큰 사용이 생산성과 연결되지 않으면 목적과 통과 기준이 불분명한 테스트나 업무와 무관한 탐색이 늘어날 수 있다. 재시도와 검토, 유지보수할 결과물만 많아지면 팀 생산성은 오히려 낮아진다.
...
제한이 지나치면 단기 목표에 집중하게 되어 하네스가 축적되지 않고, 팀 단위의 생산성 향상이 제한된다. 반대로 지나치게 풀면 생산성과 무관한 작업과 충분히 고민되지 않은 테스트가 늘어나 토큰뿐 아니라 사람의 검토와 유지보수 비용도 커진다.
