...
나도 alps-writer[^1] 를 아래에서 말하는 세 가지 방식 모두를 거쳐서 만들었기 때문에 시행착오를 겪었고, 이번에 만든 vibe-ppt-generator[^2] 도 LLM 을 오프로딩 하려고 했었다.
...
[^2]: [vibe-ppt-generator-mcp](https://github.com/haandol/vibe-ppt-generator-mcp)
