...
내가 면접관일때 묻던 질문 2가지가 있다.

1. 다른 것은 다 그냥 그렇지만 이것만 만족되면 회사를 계속 다닐 것 같다. 당신에게 이것은 무엇인가?
2. 다른 것이 다 좋지만 이것이 만족안되면 회사를 그만둘수도 있다. 당신에게 이것은 무엇인까?

나는 모든 사람이 회사를 떠나기 전, 저 두가지에 대한 답을 찾을 수 있으면 좋겠다.
...
집을 몇번 이사해봤으면 아래와 같은 질문들을 할 수 있다.
- 전세자금 대출은 되나?
- 저당금은 몇 %인가?
- 물이 적절한 수압으로 잘 나오는가?
- 욕실과 주방에 배수가 잘 되는가?
...
이런 체크리스트는 인터넷을 찾아보면 대충 나오지만 그것에 대한 확인은, 집주인에게 또는 집에 사는 사람에게 물어봐야한다. (보통은 집주인 대신 부동산이랑 대화하지만)

회사를 정할때도 마찬가지인데, 회사에서 면접 때마다 물어본다.

`우리 회사에 궁금한게 뭔가요?`

하지만 회사에 다녀보지 못한 사람 입장에서는 이렇게 의미없는 질문이 또 없다.
...
본 글에서는 사전에 조사할 내용만 다룬다. (쓰다보니 길어져서...)
...
누군가 나에게 회사에 대한 메일을 보냈을때 나는 단 한번도 답장을 안하거나 정직하지 않은 내용을 보낸적이 없다.(자신에게 메일이 왔을때를 생각해보면 된다.) 대부분 성심성의껏 보내줄 것이기 때문에 메일을 보내는 것에 큰 부담을 느낄 필요는 없다.

단 임원급에게는 보내지 않는 것이 좋다.
아무리 작은 회사에서도 임원들은 사측의 입장에서 이야기를 한다. ~~정말 이상한 일이다. 본인들도 월급쟁이인데~~

세부 내용에 대해 좀 더 상세히 적어보겠다.

### 출퇴근 시간

나에게 출퇴근은 가장 중요하다. 서태웅이 괜히 가까워서 북산에 들어간 것이 아니다. 엄청난 이점들이 많이 있기 때문이다.

`걸어서 15분 거리`와 `대중교통으로 30분 거리`는 나의 삶에 엄청나게 큰 영향을 미친다.

집이 가까우면 좋은 점이 많지만(돈, 시간 등등), 가장 큰 장점으로 `체력` 을 보전할 수 있다는 것을 들겠다.

집이 멀면 퇴근 후 뭔가 시도하는 것에 엄청난 의지가 필요한데, 개인적으로 이것은 개개인의 의지의 차이보다 `체력`적인 부분도 크다고 생각한다.

혼잡한 시간대에 혼잡한 곳을 대중교통을 이용해서 가야하는 것은 실제로 30분보다 더 걸린다.(퇴근시간도 혼잡할 것이 뻔하다.) 힘든 회사일을 마치고 남은 체력을 쥐어짜서 출퇴근에 또 쏟아내고 나면, 집에 와서 무언갈 하는 것은 사실상 사치에 가깝다.
...
공식적으로 회사에서 블로그를 관리하고 있다면 내부의 자료에 대한 문서화 수준도 높을 가능성이 크다. 그렇지 않더라고 문서화를 하는데 시간을 빼준다면 문서화에 대한 중요성을 인지는 하고 있다는 뜻이다.

대외적인 문서화를 장려하는 문화라면 개개인의 커리어 개발에 관심을 두고 있거나, 최소한 그것을 방해하지는 않고 있을 가능성이 높다.

이와는 별개로 개별 직원의 블로그나 깃허브를 찾아볼 수 있다면 찾아보면 좋은데, 대부분 링크드인으로 검색해 보면 찾아볼 수 있다.

개별 직원이 회사에서 하는 일을 정리를 하는데 블로그를 사용하고 있다면 어느정도 워라밸이 존재한다고 짐작할 수 있다. 이런 경우 해당 직원에게 메일을 보내서 물어보는 것이 제일 좋다.
